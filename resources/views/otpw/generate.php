...
<form method="POST" id="<?=$formId;?>">
	<table>
		...
		<tr>
			...
			<td><?=T::select($classsDocentLecture->getAttribute("id"), $classsDocentLectures, false, "cdl_id"); ?>
			</td>
			<td><?=T::error(); ?></td>
		</tr>
	</table>
	<button class="button submit" onclick="getElementById('<?=$formId?>').submit();">Generieren</button>
</form>
</div>
