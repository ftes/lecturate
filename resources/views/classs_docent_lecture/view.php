...
<form method="POST">
	<table>
		...
		<tr>
			...
			<td><?=T::select($model->getAttribute("l_id"), array($docentLecture)); ?>
			</td>
		</tr>
	</table>
	<?=T::iconButton(T::EDIT, "Bearbeiten", "classs_docent_lecture", "edit", 
			array("id"=>$model->getValue("id"))); ?>
	<?=T::iconButton(T::DELETE, "Löschen", "classs_docent_lecture", "delete", 
			array("id"=>$model->getValue("id"))); ?>
</form>
